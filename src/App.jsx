  ...
  return (
    <div className="min-h-screen bg-background text-card-foreground flex flex-col font-sans">
      ...
      <Routes>
        ...
        />
        <Route path="/trade/:id" element={authUser ? <TradeDetails /> : <Navigate to="/login" />} />

        <Route path="/trade" element={authUser ? <TradePage /> : <Navigate to="/login" />} />

        <Route path="/wallet" element={authUser ? <WalletScreen /> : <Navigate to="/login" />} />

        <Route path="/Leader" element={authUser ? <LeaderboardPage /> : <Navigate to="/login" />} />
